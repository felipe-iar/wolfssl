...
ether_instance_ctrl_t g_ether0_ctrl;
            ...
            __attribute__((__aligned__(32)))uint8_t g_ether0_ether_buffer0[1514]ETHER_BUFFER_PLACE_IN_SECTION;
__attribute__((__aligned__(32)))uint8_t g_ether0_ether_buffer1[1514]ETHER_BUFFER_PLACE_IN_SECTION;
